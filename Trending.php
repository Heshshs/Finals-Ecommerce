...
<body class="dashboard-page">
 ...
 <!-- New this week -->
        <div class="content-section">
            <h3 class="section-title">Top Anime Trending This Week </h3>
            <div class="anime-grid">
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">Kuroko's Basketball</h4>
                </div>
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">Chainsaw Man</h4>
                </div>
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">HunterxHunter</h4>
                </div>
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">Slam Dunk</h4>
                </div>

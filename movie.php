    ...
    <div class="main-content">
        ...
        <div class="featured-section">
            ...
            <div class="featured-overlay">
                <h2 class="featured-title">One Piece Film: Red</h2>
        ...
        <div class="content-section">
            ...
            <div class="anime-grid">
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">Jujutsu Kaisen 0: The Movie</h4>
                </div>
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">Spirited Away</h4>
                </div>
                ...
                <div class="recent-card">
                    ...
                    <h4 class="anime-title">My Neighbor Totoro</h4>
                </div>
                ...
                <div class="recent-card">
                    ...
                    <h4 class="anime-title">Weathering With You</h4>
                </div>
                ...
                <div class="recent-card">
                    ...
                    <h4 class="anime-title">The Shape of Voice</h4>
                </div>
                ...
                <div class="recent-card">
                    ...
                    <h4 class="anime-title">Chainsaw Man - The Movie: Reze Arc</h4>
                </div>
                ...
                <div class="recent-card">
                    ...
                    <h4 class="anime-title">Howl's Moving Castle</h4>
                </div>

...
<body class="dashboard-page">
   ...
   <!-- New this week -->
        <div class="content-section">
            <h3 class="section-title">Dubbed Anime </h3>
            <div class="anime-grid">
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">Frieren (Dubbed)</h4>
                </div>
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">Ride Your Wave (Dubbed)</h4>
                </div>
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">Jujutsu Kaisen (Dubbed)</h4>
                </div>
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">Kuroko's Basketball (Dubbed)</h4>
                </div>
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">Chainsaw Man (Dubbed)</h4>
                </div>
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">HunterxHunter (Dubbed)</h4>
                </div>
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">Slam Dunk (Dubbed)</h4>
                </div>
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">Black Clover (Dubbed)</h4>
                </div>
                ...
                <div class="anime-card">
                    ...
                    <h4 class="anime-title">Solo Leveling (Dubbed)</h4>
                </div>
